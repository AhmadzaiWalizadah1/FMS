...
<!--                          return button      -->
                         <a href="transcript.blade.php"><button class="btn btn-info" type="button" class="form-control">برگشت</button></a>
<!--  					export to excal  -->
			...
			<br>
				<div class="row">
					<div class="col-xs-3 col-sm-3 col-md-3">
                        ...
                        <p class="bold9"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Faculty Reg No: <u> <?php echo $_GET['eng-id']?></u></p>
					</div>
                    ...
                    <div class="col-xs-4 col-sm-4 col-md-4">
                        <div class="">
                            <table class="table table-bordered bold9 border_thick_left border_thick_top border_thin_all">
                                <?php   if (empty($_GET['eng-id'])){echo "صفحه به شکل نادرست به دسترسی قرار گرفته شده";}

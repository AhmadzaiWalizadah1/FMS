...
<div class="container-col-md-12" style="margin :none">
  <!-- first row -->
  <div class="row" >
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        ...
        <div class="carousel-caption">
          <h2 class="animated bounceInLeft" style="animation-delay: 1s;">Creativity is to become Computer Scientist </h2>
          <h3 class="animated bounceInRight" style="animation-delay:2s;" ></h3>
        </div>
      </div>
      <!-- the second item-->
      <div class="item">
        ...
        <!-- making the captions of slider-->
        <div class="carousel-caption">
          <h2 class="animated slideInDown" style="animation-delay: 1s;">Creativity is to become Computer Scientist</h2>
          <h3 class="animated slideInUp" style="animation-delay:2s;"></h3>
        </div>
      </div>
      <!-- the third item-->
      <div class="item">
        ...
        <!-- making the captions of slider-->
        <div class="carousel-caption">
          <h2 class="animated zoomIn" style="animation-delay: 1s;" >Creativity is to become Computer Scientist</h2>
          <h3 class="animated zoomIn"  style="animation-delay:2s;"></h3>
  ...
  <div class="row" >
    ...
    <div class="col-md-12 overall-container" >
      <section style= " margin-top:3%; border: 1px solid gray; text-align:right;border-radius:20px;  padding-left:3% ; padding: 2%;  box-shadow: 10px 10px 5px #888888;" >
      ...
      <div>
      <article class="Software" dir="rtl" style= " margin-top:3%; padding: 2%; border-radius:20px;  border: 1px solid gray;  box-shadow: 10px 10px 5px #888888;  text-align:right; ">
    ...
    تمنت میباشد.
        ...
        <!-- end of article -->
        <article class="Database" dir="rtl" style= " margin-top:3%;border-radius:20px;  padding: 2%; padding-bottom: 1.666%; border: 1px solid gray; text-align:right;   box-shadow: 10px 10px 5px #888888;">
    ...
    <!-- end of 12 column div -->
          ...
          <!-- Start new article -->
    <br/>
                <article dir="rtl" class="Graduation" style= " margin-top:2%;
                margin: 1%;border: 1px solid gray; text-align:right;
                  ; padding:2%; border-radius:20px;  box-shadow: 10px 10px 5px #888888;">
